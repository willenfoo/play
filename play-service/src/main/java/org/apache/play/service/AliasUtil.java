...
public class AliasUtil {
	...
	public static Map getAlias(String keys, ProceedingJoinPoint pjp, boolean both) {
		...
		if (both) {
			params.put("simple", returnType + ":" + methodName + "@" + className + params.get("simple"));
		}
		params.put("full", returnType + ":" + methodName + "@" + className + params.get("detail"));
		params.put("className", className);
		params.put("methodName", methodName);
		return params;
	}

	private static Map getAlias(String keys, MethodSignature sign, String[] paramNames, Class[] classes, Object[] args,
			boolean both) {
